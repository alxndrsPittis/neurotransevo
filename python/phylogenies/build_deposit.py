...
ENTRIES = [
    ...
    ("03", "2C", "biopterin_hydroxylases", "family", "Biopterin_H.vs.fusion.fasta", "Biopterin_H.vs.fusion.mft.fasttree", "alignment missing; unaligned sequences provided"),
    ...
    ("12", "3A", "MFS_superfamily", "SLC22_MCL-I1.4-cluster0001", "MCL_I14.0001.SLC22.clustalo.gt01", "MCL_I14.0001.SLC22.clustalo.gt01.fasttree", "to confirm"),
    ("13", "3A", "MFS_superfamily", "SLC22_cluster0001_subset", "MCL_I14.0001.SLC22.subsampled4_extended.einsi.gt01", "MCL_I14.0001.SLC22.subsampled4_extended.einsi.gt01.treefile", "to confirm"),
    ...
    ("19", "4B", "rhodopsin_GPCRs", "H-ACh_subclade_7-species_subset", "7tm_1.PF00001.21.vs.jake_cleaned_proteome_files_70.allVSall.I60.0002.filtered_4to10.clustalo.gt001.fasttree.clade_selection.clustalo.gt001.treefile.selectction_subsampled.linsi.gt01", "7tm_1.PF00001.21.vs.jake_cleaned_proteome_files_70.allVSall.I60.0002.filtered_4to10.clustalo.gt001.fasttree.clade_selection.clustalo.gt001.treefile.selectction_subsampled.linsi.gt01.lg_fasttree", "to confirm alignment variant (Clustal Omega / E-INS-i / L-INS-i trees also exist)"),
    ("20", "5A", "Cys-loop_LGICs", "family", "Neur_chan_nicotinic_receptors.vs.fusion.clustalo.gt01", "Neur_chan_nicotinic_receptors.vs.fusion.clustalo.gt01.lg_fasttree", ""),
    ("21", "5B", "Cys-loop_LGICs", "cationic_clade_subset", "Neur_chan_nicotinic_receptors.vs.fusion.subsampled3.einsi.gt01", "Neur_chan_nicotinic_receptors.vs.fusion.subsampled3.einsi.gt01.treefile", "to confirm"),
    ("22", "S1A", "NNMT-PNMT-TEMT", "family", "NNMT_PNMT_TEMT.PF01234.17.fusion.linsi.gt01", "NNMT_PNMT_TEMT.PF01234.17.fusion.linsi.gt01.treefile", ""),
    ("23", "S1B", "cytochrome_P450", "family", "p450.PF00067.VS.fusion.clustalo.gt001", "p450.PF00067.VS.fusion.clustalo.gt001.fasttree", ""),
    ("24", "S1B", "cytochrome_P450", "CYP2_clade_subset", "p450.PF00067.VS.fusion.clustalo.gt001.fasttree_clade.subclade.subsampled5_extended.einsi.gt01", "p450.PF00067.VS.fusion.clustalo.gt001.fasttree_clade.subclade.subsampled5_extended.einsi.gt01.treefile", "to confirm"),
]
...
for eid, fig, family, step, aln_name, tree_name, status in ENTRIES:
    ...
    unaligned = aln_name.endswith((".fasta", ".fa")) and "mft" not in aln_name
    ...
    rows.append({
        ...
        "Original alignment": str(aln.relative_to(ANALYSIS)), "Original tree": str(tree.relative_to(ANALYSIS)),
        "Note": status,
    })
...
readme = ("Trees and alignments of the gene-family phylogenies — Pittis et al.\n\n"
          "Files are named <ID>_<Figure>_<family>_<tree>. Each entry has an alignment (FASTA; for ID 03 only the\n"
          "unaligned sequences survive), the tree (Newick) and, for IQ-TREE runs, the IQ-TREE report.\n"
